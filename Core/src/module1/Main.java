...
public class Main {
    public static void main(String[] args) {
        // jvm => là máy ảo của java
        // int a = 1; printf("%d", a) -> C
        // c => mã máy(0, 1) => ra kết qua => 1 (ngôn ngữ lập trình bậc thấp)
        // Ngôn ngữ lập trình bâc thấp => nó gần với mã máy và khó hiểu cho con người
        // java => jvm (.class) => mã máy => kết quả (ngôn ngữ lập trình bậc cao)
        // Nó gần với cách hiểu của người
